...
enum assoc { 
    ASSOC_LEFT, // de derecha a izquierda (ej: ^)
    ASSOC_RIGHT, // de izquierda a derecha (ej: +-/*)
};
...
/* *****************************************************************
 *                   PRIMITIVAS DE PILATOK
 * *****************************************************************/

/* 
 * Wrappers para no castear los punteros de tokens a void o viceversa
 */

typedef pila_t pilatok_t;
...
/* *****************************************************************
 *                   PRIMITIVAS DE COLATOK
 * *****************************************************************/

/* 
 * Analogamente a los wrappers de la pila, en este caso usamos una cola de punteros
 * a calc_token. Dado que no necesito reutilizar los tokens una vez encolados (mas
 * que para imprimirlos al desencolarlos), los wrappers no hacen copia de los tokens,
 * sino que utiliza los tokens que le paso.
 */

typedef cola_t colatok_t;
